...
class MemoryBudgetManager:
    ...
    def _handle_pressure_level_increase(self, pressure_level):
        ...
        try:
            ...
            from src_OLD.components.messaging.component_state import get_state, StateType
            ...
            if arch_state and "active_components" in arch_state.value:
                ...
                if components_to_deactivate:
                    # Import here to avoid circular imports
                    from src_OLD.components.messaging.message_protocol import send_message, Message, MessageType
    ...
    def _get_dynamic_importance_factors(self, component_id: str) -> float:
        ...
        from src_OLD.components.messaging.message_protocol import MessageType
