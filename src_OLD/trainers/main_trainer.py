...
def train_blt_entropy(config):
    ...
    from src_OLD.utils.config import (
...
def train_mvot_codebook(config):
    ...
    from src_OLD.trainers.data_preparation import create_mock_models
    import argparse
...
def train_full_model(config):
    ...
    from src_OLD.models.unified_architecture import UnifiedArchitecture
    from src_OLD.trainers.hardware_aware_trainer import HardwareAwareTrainer
...
class ByteDataset(Dataset):
    ...
    def __init__(self, file_paths, block_size=128, cache_dir=None):
        ...
        from src_OLD.data.processors.text_processor import TextDataProcessor
        from src_OLD.data.processors.binary_processor import BinaryDataProcessor
